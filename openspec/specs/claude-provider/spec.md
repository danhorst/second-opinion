...
The claude adapter's provider-specific requirements: cold invocation including harness-global-context suppression, prompt-embedded material, JSON provenance extraction, did-not-run classification.
